      ...
      <div className="w-full">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 w-full">
          <motion.div
            ...
            className="flex flex-col py-6 px-6 rounded-xl border bg-neutral-900/40 border-green-500/30 hover:border-green-400/50 duration-200 cursor-pointer"
          >
            <h1 className="mb-5 text-center text-slate-300 font-bold text-lg">Programming Languages</h1>
            <div className="flex flex-wrap gap-4 justify-center">
              <TechnologyCard technologyIcon={<FaC className="text-blue-500 sm:size-6 size-5" />} technologyName="C" />
              <TechnologyCard technologyIcon={<TbBrandCpp className="text-blue-500 sm:size-6 size-5" />} technologyName="C++" />
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1 }}
            transition={{ duration: 3 }}
            className="flex flex-col py-6 px-6 rounded-xl bg-neutral-900/40 border border-purple-500/30 hover:border-purple-400/50 duration-300 cursor-pointer"
          >
            <h1 className="mb-5 text-center text-slate-300 font-bold text-lg">Frontend</h1>
            <div className="flex flex-wrap gap-4 justify-center">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1 }}
            transition={{ duration: 3 }}
            className="flex flex-col py-6 px-6 rounded-xl bg-neutral-900/40 border border-blue-500/30 hover:border-blue-400/50 duration-300 cursor-pointer"
          >
            <h1 className="mb-5 text-center text-slate-300 font-bold text-lg">Backend</h1>
            <div className="flex flex-wrap gap-4 justify-center">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1 }}
            transition={{ duration: 3 }}
            className="flex flex-col py-6 px-6 rounded-xl bg-neutral-900/40 border border-yellow-500/30 hover:border-yellow-400/50 duration-300 cursor-pointer"
          >
            <h1 className="mb-5 text-center text-slate-300 font-bold text-lg">Tools</h1>
            <div className="flex flex-wrap gap-4 justify-center">
